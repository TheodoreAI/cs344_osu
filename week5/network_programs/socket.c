...
* Sets up a program to create a socket address corresponding to the hostname and the port number passed in as arguments to the program.
* I can use this program to get the IP address that corresponds to a specific port number. This program is extremely useful.
*/
